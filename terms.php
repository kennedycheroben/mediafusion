                ...
                <div class="glass-card shadow-lg p-5">
                    ...
                    <div class="content-section mb-4">
                        ...
                        <p class="text-secondary">
                            By accessing and using <strong>MediaFusion</strong>, you agree to comply with and be bound by these Terms of Service. If you do not agree, you must immediately cease all access and revoke active authorization tokens.
                        </p>
                    </div>
                    ...
                    <div class="content-section mb-4">
                        ...
                        <p class="text-secondary">
                            MediaFusion is a high-performance multi-platform media distribution and pipeline utility intended solely for authorized social media account management. The system facilitates:
                        </p>
                    ...
                    <div class="content-section mb-4">
                        ...
                        <ul class="text-secondary list-unstyled ps-3">
                            <li class="mb-2"><i class="fa-solid fa-user text-magenta me-2"></i> <strong>User Responsibility:</strong> You maintain complete, sole, and exclusive ownership and responsibility for the content, quality, copyright, and appropriateness of any materials, videos, or assets uploaded or distributed through MediaFusion.</li>
                            <li class="mb-2"><i class="fa-solid fa-shield text-magenta me-2"></i> <strong>Third-Party Compliance:</strong> You must strictly follow the terms of service and community guidelines of external streaming engines like YouTube, TikTok, and Instagram. MediaFusion is not responsible for any platform policy violations or suspensions.</li>
                        </ul>
                    </div>
